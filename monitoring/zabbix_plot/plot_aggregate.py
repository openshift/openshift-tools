...
# Purpose: Plots a bar chart from aggregated event occurences
...
parser.add_argument('-n', '--num-hosts', type=int, help='number of hosts contained in host group. the default is the '
                    'number of hosts seen in the returned data, but this number will exclude hosts with no events.')
...
plot.plot_aggregate(args.periods, args.num_hosts)
