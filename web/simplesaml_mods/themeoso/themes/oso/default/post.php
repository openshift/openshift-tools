...
<head>
        ...
        <title>SAML redirect</title>
        <script type="text/javascript" src="<?php echo SimpleSAML_Module::getModuleURL('themeoso/post.js'); ?>"></script>
        <link rel='stylesheet' href="<?php echo SimpleSAML_Module::getModuleURL('themeoso/oso.css'); ?>" type='text/css' />

</head>
<body>
<h3>One moment while you are redirected...</h3>
        ...
        <input type="submit" class="display_none" />
<?php
