...
| Ansible Roles MUST NOT depend or call into other roles.
|===
...
.Exceptions:
* Tech profiles are allowed to depend / call into other roles.
* All roles are allowed to depend / call into lib_* roles.
