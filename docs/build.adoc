...
For more information on tito, please see the https://github.com/dgoodwin/tito[Tito GitHub repo]

== One Time Setup
To build the python-openshift-tools-* and openshift-tools-* rpms, we use https://github.com/dgoodwin/tito[Tito]
