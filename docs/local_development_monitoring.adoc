...
To clean them out, run the `oo-clean-zaio.yml` playbook, located in the openshift-tools git repo https://github.com/openshift/openshift-tools/blob/prod/ansible/playbooks/adhoc/zabbix_setup/oo-clean-zaio.yml[here].
