...
To clean them out, run the clean_zabbix.yml playbook, located in the openshift-ansible git repo https://github.com/openshift/openshift-ansible/blob/master/playbooks/adhoc/zabbix_setup/clean_zabbix.yml[here].

.Example of running the clean_zabbix.yml playbook:
----
> cd openshift-ansible/playbooks/adhoc/zabbix_setup/
> ansible-playbook clean_zabbix.yml
----
...
To do this, run the setup_zabbix.yml playbook.
...
----
> cd openshift-ansible/playbooks/adhoc/zabbix_setup/
> ansible-playbook setup_zabbix.yml
----
