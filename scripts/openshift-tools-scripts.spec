...
cp -p monitoring/cron-send-project-limitrange-status.py %{buildroot}/usr/bin/cron-send-project-limitrange-status
...
/usr/bin/cron-send-project-limitrange-status
