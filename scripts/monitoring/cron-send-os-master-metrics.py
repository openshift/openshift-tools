...
class OpenshiftMasterZaggClient(object):
    ...
    def api_ping(self):
        ...
        try:
            ...
            print "Problem communicating with the Openshift API: %s " % ex.message
    ...
    def project_count(self):
        ...
        try:
            ...
            print "Problem performing project count check: %s " % ex.message
    ...
    def pod_count(self):
        ...
        try:
            ...
            print "Problem performing pod count check: %s " % ex.message
    ...
    def user_count(self):
        ...
        try:
            ...
            print "Problem performing user count check: %s " % ex.message
